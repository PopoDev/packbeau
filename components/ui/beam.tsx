  ...
  "relative after:content-[''] after:absolute after:inset-0 after:rounded-full after:scale-200",
  {
    variants: {
      tone: {
        ...
        brand:
          "after:bg-radial after:from-primary/10 dark:after:from-primary/30 after:from-10% after:to-primary/0 after:to-60%",
        brandLight:
          "after:bg-radial dark:after:from-primary-foreground/30 after:from-primary-foreground/10 after:from-10% after:to-primary-foreground/0 after:to-60%",
      },
    },
    defaultVariants: {
      tone: "default",
